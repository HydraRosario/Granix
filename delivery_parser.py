...
class DeliveryReportParser:
    ...
    def parse_delivery_report_text(self, raw_ocr_text: str) -> dict:
        ...
        for line in lines:
            ...
            if item_match:
                ...
                commercial_entity, delivery_address = self._extract_commercial_entity_and_address(rest_of_line_after_packages)
    ...
    def _extract_commercial_entity_and_address(self, text: str) -> tuple[str, str]:
        ...
        return commercial_entity, delivery_address
